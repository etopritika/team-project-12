    ...
    movieTrand.innerHTML = movies
      .map(
        ...
        <li class="movie-card__item">
          <a class="movie-card__link" href="https://www.themoviedb.org/movie/${movie.id}">
          ...
          ${movie.genre_ids.map(genre_id => `<a href="https://www.themoviedb.org/genre/${genre_id}">${getGenreId(genre_id)}</a>`).join(', ')}
        </div>
